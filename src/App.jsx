      ...
      <section id="home" className="pt-16 min-h-screen flex items-center justify-center px-4">
        <div className="text-center max-w-4xl">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-6 justify-center">
            <a 
              href="#projects" 
              className="bg-white hover:bg-teal-500 text-gray-800 hover:text-slate-500 font-medium py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl nice-font"
            >
              View my work
            </a>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-6 justify-center">
            <button 
              className="bg-white hover:bg-teal-500 text-gray-800 hover:text-slate-500 font-medium py-3 px-6 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 nice-font"
          ...
          <div className="bg-stone-450/95 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-stone-400/50">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center">
                <div className="w-64 h-64 bg-gradient-to-br from-stone-500 to-stone-600 rounded-full flex items-center justify-center shadow-xl">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-stone-450/95 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-stone-400/50">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://github.com/VihaanLearnsCode" className="w-12 h-12 bg-stone-600 hover:bg-stone-500 rounded-full flex items-center justify-center text-slate-500 transition-all shadow-lg">
              ...
              <a href="https://linkedin.com/in/vihaank" className="w-12 h-12 bg-stone-700 hover:bg-stone-600 rounded-full flex items-center justify-center text-slate-500 transition-all shadow-lg">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
