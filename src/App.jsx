        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-stone-500/95 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-stone-400/50">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://github.com/VihaanLearnsCode" className="w-12 h-12 bg-stone-600 hover:bg-stone-500 rounded-full flex items-center justify-center text-white transition-all shadow-lg">
              ...
              <a href="https://linkedin.com/in/vihaank" className="w-12 h-12 bg-stone-700 hover:bg-stone-600 rounded-full flex items-center justify-center text-white transition-all shadow-lg">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
