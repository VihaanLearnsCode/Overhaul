        ...
        <div className="text-center max-w-4xl">
          <div className="bg-teal-900/90 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-teal-800/50">
            <span className="text-5xl md:text-7xl font-bold text-teal-50 mb-6 nice-font">
              Hi, I'm <span className="text-amber-200">Vihaan Khare</span>
            </span>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-teal-700/80 backdrop-blur-sm p-4 rounded-lg shadow-sm">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-teal-700/90 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-teal-600/50">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-teal-600/90 backdrop-blur-sm rounded-lg p-6 hover:transform hover:scale-105 transition-all shadow-lg hover:shadow-xl">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-teal-600/90 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-teal-500/50">
            ...
            <div className="flex justify-center gap-4">
              <a href="https://github.com/VihaanLearnsCode" className="w-12 h-12 bg-teal-600 hover:bg-teal-500 rounded-full flex items-center justify-center text-white transition-all shadow-lg">
